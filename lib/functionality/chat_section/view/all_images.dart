        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: Text(
                'All Images',
                style: TextStyle(color: isColorValidation(context)),
              ),
            ),
          ),
          StreamBuilder(
            ...
            builder:
              ...
              if (snapshot.hasError) {
                debugPrint("Firestore Error in AllImages: ${snapshot.error}");
              ...
              // Filter images in memory if not already filtered by query
              ...
              if (imageDocs.isEmpty) {
                return SliverFillRemaining(
                  child: Center(child: Text("No images found in this chat.")),
                );
              }
