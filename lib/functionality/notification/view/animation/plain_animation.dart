...
class PlaneIndicator extends StatefulWidget {
  ...
  final Future<void> Function()? onRefreshAnim;
...
class _PlaneIndicatorState extends State<PlaneIndicator>
  ...
  static final _clouds = [
    ...
    _Cloud(
      ...
      initialValue: 0.15,
      dy: 18.0,
      image: const AssetImage("assets/images/cloud3.png"),
      width: 40,
      duration: const Duration(milliseconds: 1600),
    ),
    _Cloud(
      ...
      initialValue: 0.3,
      dy: 65.0,
      image: const AssetImage("assets/images/cloud2.png"),
      width: 60,
      duration: const Duration(milliseconds: 1600),
    ),
    _Cloud(
      ...
      initialValue: 0.8,
      dy: 70.0,
      image: const AssetImage("assets/images/cloud4.png"),
      width: 100,
      duration: const Duration(milliseconds: 1600),
    ),
    _Cloud(
  ...
  Future<void> refreshIndi() async {
    context.read<ShowNotificationBloc>().add(ShowLoadNotifications());
  }
